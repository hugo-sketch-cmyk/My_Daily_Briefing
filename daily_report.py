...
def get_llm_summary(market_data):
    ...
    - **全球组合审计 (Anchor)**：
        - 核心标的：针对 Xiaomi (01810.HK)，必须以 29.09 HKD (2026-04-30) 为审计基准点分析异动逻辑。
        - 板块监控：WuXi AppTec、JCET、Paradigm Intelligent 的因果链分析。
    ...
    - **实体监控**：真迈 (GeneMind)、GenePlanet、SOPHIA、MSK 仅在发生格局性变量时汇报，严禁冗余。

    ### 🛡️ 综合决策建议 (Strategic So-What)
    - 结合第一层全球流动性波动与第二层拉美落地环境（如墨西哥实验室装修收尾与设备到港），给出批判性行动建议。
